...
<?php
	...
	{
		mysqli_query($db,"INSERT into `lms`.`message` VALUES ('', '$_SESSION[login_user]','$_POST[message]','no','student');");
...
<div class="wrapper">
	<div style="height: 70px; width: 100%; background-color: hotpink; text-align: center; color:black; ">
