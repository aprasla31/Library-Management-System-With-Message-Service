   ...
   <br>
    <div class="box1">
      ...
      <form  name="login" action="" method="post">
        <b><p style="padding-left:50px;font-size: 15px;">Login As:</p></b>
    ...
    if(isset($_POST['submit']))
    {
      ...
      if($count==0)
      {
        ?>
              ...
              -->
          <div class="alert alert-danger" style="width: 500px; margin-left: 460px; background-color: #de1313; color: white">
            <strong>The username and password doesn't match<br>Or Your ID Is Not Approved</strong>
          </div>    
        <?php
      }
      else
      ...
      if($count==0)
      {
        ?>
          ...
          <div class="alert alert-danger" style="width: 600px; margin-left: 460px; background-color: #de1313; color: white">
