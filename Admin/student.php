...
function closeNav() {
  ...
  document.body.style.backgroundColor = "white";
	...
	<?php
		...
		{
			$q=mysqli_query($db,"SELECT fullname,email,username,roll,contact FROM `student` where username like '%$_POST[search]%' ");
		...
		{
			$res=mysqli_query($db,"SELECT fullname,email,username,roll,contact FROM `student`;");
